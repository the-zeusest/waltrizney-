...
(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .song-animal-icon { width: 64px; height: 64px; flex: 0 0 64px; object-fit: contain; border-radius: 10px; background: #000; padding: 2px; }
      .song-animal-fallback { display: inline-grid; place-items: center; width: 64px; height: 64px; flex: 0 0 64px; font-size: 2.2rem; background: #000; border-radius: 10px; }
      ...
      @media (max-width: 640px) {
        .song-animal-icon, .song-animal-fallback { width: 52px; height: 52px; flex-basis: 52px; }
